...
public class Restricoes extends AbstractRestricao {
	...
	private Restricoes(String alias, String nome, TipoOperador tipoOperador, Object valor,
			TipoConectivo tipoConectivo) {
		this.alias = alias;
		this.nome = nome;
		this.tipoOperador = tipoOperador;
		this.tipoConectivo = tipoConectivo;
	...
	public static Restricoes igualComAlias(String aliasTabela, String nome, Object valor) {
		return criarRestricaoComAlias(aliasTabela, nome, TipoOperador.IGUAL, atribuirLowerCaseCasoSejaString(valor),
				TipoConectivo.AND);
	}
	...
	public static Restricoes maiorOuIgualQue(String aliasTabela, String nome, Object valor,
			TipoConectivo tipoConectivo) {
	...
	public static Restricoes menorOuIgualQue(String aliasTabela, String nome, Object valor,
			TipoConectivo tipoConectivo) {
	...
	public static Restricoes like(String nome, Object valor) {
		return criarRestricao(nome, TipoOperador.LIKE,
				adicionarPorcentagemAoValorPesquisado(atribuirLowerCaseCasoSejaString(valor)), TipoConectivo.AND);
	}

	public static Restricoes like(String nome, Object valor, TipoConectivo tipoConectivo) {
		return criarRestricao(nome, TipoOperador.LIKE,
				adicionarPorcentagemAoValorPesquisado(atribuirLowerCaseCasoSejaString(valor)), tipoConectivo);
	}

	public static Restricoes likeComAlias(String aliasTabela, String nome, Object valor) {
		return criarRestricaoComAlias(aliasTabela, nome, TipoOperador.LIKE,
				adicionarPorcentagemAoValorPesquisado(atribuirLowerCaseCasoSejaString(valor)), TipoConectivo.AND);
	}
	...
	private static Restricoes criarRestricao(String nome, TipoOperador tipoOperador, Object valor,
			TipoConectivo tipoConectivo) {
		return new Restricoes(nome, tipoOperador, valor, tipoConectivo);
	}

	private static Restricoes criarRestricaoComAlias(String aliasTabela, String nome, TipoOperador tipoOperador,
			Object valor, TipoConectivo tipoConectivo) {
	...
	private static String toLowerCase(Object valor) {
		if (CheckerUtil.isNotNull(valor)) {
	...
	public Restricoes cloneRestricao() {
		return new Restricoes(this.getAlias(), this.getNome(), this.getTipoOperador(), this.getValor(),
				this.getTipoConectivo());
	}
